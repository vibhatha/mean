...
angular.module('graphs').controller('GraphsController', ['$scope', '$routeParams', '$location', 'Authentication', 'Graphs','Powers','Devices',
    function($scope, $routeParams, $location, Authentication, Graphs,Powers,Devices) {
        ...
        $scope.options = {
            chart: {
                ...
                xAxis: {
                    ...
                    return d3.time.format('%x')(new Date(d.x))
                     }
                },
                yAxis: {
                    axisLabel: 'Voltage (v)',
       ...
       $scope.getDeviceById=function(id){
        ...
        function getPowerFilteredByDevice1 (){
           //
            
          var powers=[];
          var data = Powers.query({'devices':'559e0c048dfa11781552c9c6' }, function() {
                  
               console.log("devices filter"+data.length);
               
             
            });
            
            
             var data1 = Powers.query({}, function() {
                  
               console.log("non devices filter"+data1.length);
