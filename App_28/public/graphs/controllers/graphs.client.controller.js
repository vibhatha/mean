...
angular.module('graphs').controller('GraphsController', ['$scope', '$routeParams', '$location', 'Authentication', 'Graphs','Powers','Devices','SmartPlugs',
    function($scope, $routeParams, $location, Authentication, Graphs,Powers,Devices,SmartPlugs) {
      ...
      //  $scope.getTotalPowerConsumedPerDevice('559e0c048dfa11781552c9c6');
        ...
        $scope.getTotalPowerConsumptionFromEachDeviceByDay =function(mm,dd,yy){
       ...
       // get power consumption by year
         $scope.getTotalPowerConsumptionFromEachDeviceByYear =function(yy){
       ...
       ///////////////////////////////////////////////////////////////////
         ...
         $scope.getTotalPowerConsumptionFromEachDeviceByMonth =function(mm,yy){
       ...
       /////////////////////////////////////////
        // yy2 > yy1 and mm1 > mm2
        $scope.getTotalPowerConsumptionFromEachDeviceByMonthRange =function(mm1,yy1,mm2,yy2){
        ...
        ///////////////////////////////////////////////////////////////////////////
         ...
         /////////////////////////////////////////
        // yy2 > yy1 
        $scope.getTotalPowerConsumptionFromEachDeviceByYearRange =function(yy1,yy2){
         ...
         /////////////////////////////////////////
        // yy2 > yy1 and mm1 > mm2
        $scope.getTotalPowerConsumptionFromEachDeviceByDayRange =function(mm1,dd1,yy1,mm2,dd2,yy2){
        ...
        $scope.getTotalPowerConsumptionFromEachDeviceByDay("6","5","2015");

        $scope.getTotalPowerConsumptionFromEachDeviceByYear("2015");

        $scope.getTotalPowerConsumptionFromEachDeviceByMonth("6","2015");


        $scope.getTotalPowerConsumptionFromEachDeviceByMonthRange("2","2015","8","2015")
         $scope.getTotalPowerConsumptionFromEachDeviceByYearRange("2013","2014")
         $scope.getTotalPowerConsumptionFromEachDeviceByDayRange("4","5","2015","6","7","2015");
