                           ...
                           if( mm==((date.getMonth())+1) && yy==date.getFullYear() && (val1.day)==date.getDate() ){
                            ...
                            plotData.push({value:totalPower});
                             ...
                             plotObject.push({seriesname:device.name,data:plotData});
                                ...
                                $scope.attrs2.caption='Power Consumption of Month - '+month;
                            //    console.log("maxPar: "+maxPar)
                   ...
                   angular.forEach(data, function(device,key){
                    ...
                    var plotObject=[];       
                     ...
                     //    console.log(device._id)
                         ...
                         console.log("======>"+dd1+"/"+mm1+"/"+yy1+"==>"+date1.getDate()+"/"+date1.getMonth())
                         
                         if(!(date1.getDate()==dd1 && date1.getFullYear()==yy1 && (date1.getMonth()+1)==mm1)){
                             ...
                             status =false;
                                 ...
                                 var consN = parseInt(consumSplit[0]);
                                 var milli = date.getTime(); 
                                console.log((date1.getMonth()+1)+"/"+date1.getDate()+'-==-'+(date.getMonth()+1)+"/"+date.getDate())     
                       
 if( (date1.getMonth()+1)==((date.getMonth())+1) && date1.getFullYear()==date.getFullYear() && date1.getDate()==date.getDate() ){                           
                               totalPower+=(consN*10/3600);
                               selectedMonth=date;
