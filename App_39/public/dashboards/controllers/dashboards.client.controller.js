...
//ngDialog Controlling Section Start        
 ...
 $scope.dateRangesummaryOnMaximumPowerUsagePerDevice.push({device:device.name, power:totalPower.toFixed(2)});
