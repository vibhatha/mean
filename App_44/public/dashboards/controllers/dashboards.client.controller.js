...
angular.module('dashboards').controller('DashboardsController', ['$scope','$window','$timeout' ,'$routeParams', '$location', 'Authentication', 'Dashboards','Powers','Devices','SmartPlugs','ngDialog','$interval', 'roundProgressService',
    function($scope,$window,$timeout, $routeParams, $location, Authentication, Dashboards,Powers,Devices,SmartPlugs,ngDialog,$interval, roundProgressService) {
        ...
        $scope.getMonthGraph = function(){
         //$scope.setThisMonthGraphData();  
          $scope.getPowerPerDayGraph('2015-07-02');
        ...
        $scope.getTodayGraph = function(){
           $scope.getPowerPerHourGraph('2015-07-03'); 
...
var monthlist = [{key:'1',month:'1',days:31},{key:'2',month:'2',days:31},{key:'3',month:'3',days:31},{key:'4',month:'4',days:31},{key:'5',month:'5',days:31},{key:'6',month:'6',days:31},{key:'7',month:'7',days:31},{key:'8',month:'8',days:31},{key:'9',month:'9',days:31},{key:'10',month:'10',days:31},{key:'11',month:'11',days:31},{key:'12',month:'12',days:31}];
  ...
  var condition3 = (mm==((date.getMonth())+1) && yy==date.getFullYear() && (dd==(date.getDate())-1));                                     
