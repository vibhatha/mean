...
$scope.dataset = [
    ...
    },
    {
        ...
        $scope.getSearchData= function(){
            ...
            $scope.getPowerPerHourGraph(start_date);  
           ...
           // $scope.getPowerPerDayRangeGraph_db(start_date,end_date);
                         ...
                         angular.forEach(monthlist,function(val,key){
                           ...
                           //  console.log(device._id+" "+(key+1))
                             ...
                             angular.forEach(powerList,function(power,key){
                                 ...
                                 if( ((val.month))==(date.getMonth()+1) && yy==date.getFullYear() ){
                                     
                                     totalPower+=(consN*10/3600);
                                     console.log("Annual Power Test Date: "+(date.getMonth()+1)+" ");
                                     console.log("Compare Dates: "+val.month+"==="+(date.getMonth()+1));
                                 }
...
var chkSum=condition4 && condition5 && condition6;              
 ...
 //  console.log("Condition 6:"+condition6)  
        ...
        $scope.getPowerPerDayRangeGraph_db = function(start_date,end_date){
             console.log('####@@@@@@@@@&&&&*********');
             console.log('Advanced Day by range');
             ...
             Devices.query({},function(data){
                  ...
                  angular.forEach(data, function(device,key){
                      ...
                      var power_data = Powers.query({device:device._id,created: {$gt:{$date:start_date},$lt:{$date:end_date} } },function(response){
